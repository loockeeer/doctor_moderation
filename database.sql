...
alter sequence mod_seq owner to postgres;

create type mention_type as enum ('no', 'partner_role', 'here', 'everyone');

alter type mention_type owner to postgres;
...
create table if not exists bot_category_type
(
    id   serial  not null
        constraint bot_category_type_pkey
            primary key,
    name varchar not null
);

alter table bot_category_type
    owner to postgres;

create table if not exists bot_language_type
(
    id   serial  not null
        constraint bot_language_type_pkey
            primary key,
    name varchar not null
);

alter table bot_language_type
    owner to postgres;
...
(
    ...
    activity smallint default 0 not null,
...
(
    id      varchar default (concat('sugg-', (uuid_generate_v4())::character varying))::character varying not null
        constraint suggestion_pkey
            primary key,
    user_id bigint                                                                                        not null
        constraint suggestion_user_id_fk
            references "user",
...
(
    id varchar default (concat('tuto-', (uuid_generate_v4())::character varying))::character varying not null
...
(
    moderator_id      bigint                                         not null
        constraint warn_moderator_id_fkey
            references "user",
    target_id         bigint                                         not null
        constraint warn_target_id_fkey
            references "user",
    reason            varchar,
    created_timestamp timestamp default CURRENT_TIMESTAMP            not null,
    id                integer   default nextval('mod_seq'::regclass) not null
        constraint warn_pk
            primary key
);
...
(
    user_id bigint  not null
        constraint user_link_user_id_fkey
            references "user",
    name    varchar not null,
...
(
    bot_id bigint  not null
        constraint bot_link_bot_id_fkey
            references bot,
    name   varchar not null,
    link   varchar not null
);

alter table bot_link
    owner to postgres;

create table if not exists user_title
(
    user_id bigint  not null
        constraint user_title_user_id_fkey
            references "user",
    name    varchar not null
);
...
(
    bot_id  bigint not null
        constraint bot_owner_bot_id_fkey
            references bot,
    user_id bigint not null
        constraint bot_owner_user_id_fkey
            references "user"
);

alter table bot_owner
    owner to postgres;

create table if not exists bot_category
(
    bot_id      bigint  not null
        constraint bot_category_bot_id_fkey
            references bot,
    category_id integer not null
        constraint bot_category_category_id_fkey
            references bot_category_type
);

alter table bot_category
    owner to postgres;

create table if not exists bot_language
(
    bot_id      bigint  not null
        constraint bot_language_bot_id_fkey
            references bot,
    language_id integer not null
);

alter table bot_language
    owner to postgres;

create table if not exists note
(
    bot_id        bigint
        constraint note_bot_id_fkey
            references bot,
    suggestion_id varchar
        constraint note_suggestion_id_fkey
            references suggestion,
    tutorial_id   varchar
        constraint note_tutorial_id_fkey
            references tutorial,
    checker       boolean,
    stars         smallint default 0 not null,
    constraint note_check
        check (((suggestion_id)::text = NULL::text) AND ((tutorial_id)::text = NULL::text)),
    constraint note_check1
        check ((bot_id = NULL::bigint) AND ((tutorial_id)::text = NULL::text)),
    constraint note_check2
        check ((bot_id = NULL::bigint) AND ((suggestion_id)::text = NULL::text)),
    constraint note_check3
        check ((bot_id <> NULL::bigint) OR ((suggestion_id)::text <> NULL::text) OR ((tutorial_id)::text <> NULL::text))
);
...
(
    user_id    bigint  not null
        constraint api_key_user_id_fkey
            references "user",
    key        bigint  not null,
...
(
    target_id    bigint                                         not null
        constraint ban_target_id_fkey
            references "user",
    moderator_id bigint                                         not null
        constraint ban_moderator_id_fkey
            references "user",
    createdat    timestamp default CURRENT_TIMESTAMP            not null,
    time         bigint    default '-1'::integer                not null,
    reason       varchar,
    id           integer   default nextval('mod_seq'::regclass) not null
        constraint ban_pk
            primary key
...
(
    target_id    bigint                                         not null
        constraint kick_target_id_fkey
            references "user",
    moderator_id bigint                                         not null
        constraint kick_moderator_id_fkey
            references "user",
    createdat    timestamp default CURRENT_TIMESTAMP            not null,
    reason       varchar,
    id           integer   default nextval('mod_seq'::regclass) not null
...
(
    target_id    bigint                                         not null
        constraint mute_target_id_fkey
            references "user",
    moderator_id bigint                                         not null
        constraint mute_moderator_id_fkey
            references "user",
    createdat    timestamp default CURRENT_TIMESTAMP            not null,
    time         bigint    default '-1'::integer                not null,
    reason       varchar,
...
create table if not exists bot_programming_language_type
(
    name varchar not null,
    id   integer generated always as identity
        constraint bot_programming_language_type_pkey
            primary key
);

alter table bot_programming_language_type
    owner to postgres;

create table if not exists bot_programming_language
(
    bot_id                  bigint  not null
        constraint bot_programming_language_bot_id_fkey
            references bot,
    programming_language_id integer not null
        constraint bot_programming_language_programming_language_id_fkey
            references bot_programming_language_type
);

alter table bot_programming_language
    owner to postgres;
...
(
    id   integer generated always as identity
        constraint help_doc_pk
            primary key,
    name varchar not null,
    link varchar not null
);

alter table help_doc
    owner to postgres;

create table if not exists error_explanation
(
    id          integer generated always as identity
        constraint error_explanation_pkey
            primary key,
    user_id     bigint  not null
        constraint error_explanation_user_id_fkey
            references "user",
    error       varchar not null,
    explanation varchar not null
);

alter table error_explanation
    owner to postgres;
...
(
    ...
    delegate_id       bigint                                  not null
        constraint partner_delegate_id_fkey
            references "user",
    guild_description varchar                                 not null,
    mention_type      mention_type default 'no'::mention_type not null
);
...
create or replace view information_schema._pg_foreign_data_wrappers
            (authorization_identifier, fdwoptions, fdwowner, foreign_data_wrapper_catalog,
             foreign_data_wrapper_language, foreign_data_wrapper_name, oid)
as
-- missing source code
;

create or replace view information_schema._pg_foreign_servers
            (authorization_identifier, foreign_data_wrapper_catalog, foreign_data_wrapper_name, foreign_server_catalog,
             foreign_server_name, foreign_server_type, foreign_server_version, oid, srvoptions)
as
-- missing source code
;

create or replace view information_schema._pg_foreign_table_columns(attfdwoptions, attname, nspname, relname) as
-- missing source code
;

create or replace view information_schema._pg_foreign_tables
            (authorization_identifier, foreign_server_catalog, foreign_server_name, foreign_table_catalog,
             foreign_table_name, foreign_table_schema, ftoptions)
as
-- missing source code
;

create or replace view information_schema._pg_user_mappings
            (authorization_identifier, foreign_server_catalog, foreign_server_name, oid, srvowner, umoptions, umuser) as
-- missing source code
;

create or replace view information_schema.administrable_role_authorizations(grantee, is_grantable, role_name) as
-- missing source code
;

create or replace view information_schema.applicable_roles(grantee, is_grantable, role_name) as
-- missing source code
;

create or replace view information_schema.attributes
            (attribute_default, attribute_name, attribute_udt_catalog, attribute_udt_name, attribute_udt_schema,
             character_maximum_length, character_octet_length, character_set_catalog, character_set_name,
             character_set_schema, collation_catalog, collation_name, collation_schema, data_type, datetime_precision,
             dtd_identifier, interval_precision, interval_type, is_derived_reference_attribute, is_nullable,
             maximum_cardinality, numeric_precision, numeric_precision_radix, numeric_scale, ordinal_position,
             scope_catalog, scope_name, scope_schema, udt_catalog, udt_name, udt_schema)
as
-- missing source code
;

create or replace view information_schema.character_sets
            (character_repertoire, character_set_catalog, character_set_name, character_set_schema,
             default_collate_catalog, default_collate_name, default_collate_schema, form_of_use)
as
-- missing source code
;

create or replace view information_schema.check_constraint_routine_usage
            (constraint_catalog, constraint_name, constraint_schema, specific_catalog, specific_name,
             specific_schema) as
-- missing source code
;

create or replace view information_schema.check_constraints(check_clause, constraint_catalog, constraint_name, constraint_schema) as
-- missing source code
;

create or replace view information_schema.collation_character_set_applicability
            (character_set_catalog, character_set_name, character_set_schema, collation_catalog, collation_name,
             collation_schema) as
-- missing source code
;

create or replace view information_schema.collations(collation_catalog, collation_name, collation_schema, pad_attribute) as
-- missing source code
;

create or replace view information_schema.column_domain_usage
            (column_name, domain_catalog, domain_name, domain_schema, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.column_options
            (column_name, option_name, option_value, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.column_privileges
            (column_name, grantee, grantor, is_grantable, privilege_type, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.column_udt_usage
            (column_name, table_catalog, table_name, table_schema, udt_catalog, udt_name, udt_schema) as
-- missing source code
;

create or replace view information_schema.columns
            (character_maximum_length, character_octet_length, character_set_catalog, character_set_name,
             character_set_schema, collation_catalog, collation_name, collation_schema, column_default, column_name,
             data_type, datetime_precision, domain_catalog, domain_name, domain_schema, dtd_identifier,
             generation_expression, identity_cycle, identity_generation, identity_increment, identity_maximum,
             identity_minimum, identity_start, interval_precision, interval_type, is_generated, is_identity,
             is_nullable, is_self_referencing, is_updatable, maximum_cardinality, numeric_precision,
             numeric_precision_radix, numeric_scale, ordinal_position, scope_catalog, scope_name, scope_schema,
             table_catalog, table_name, table_schema, udt_catalog, udt_name, udt_schema)
as
-- missing source code
;

create or replace view information_schema.constraint_column_usage
            (column_name, constraint_catalog, constraint_name, constraint_schema, table_catalog, table_name,
             table_schema) as
-- missing source code
;

create or replace view information_schema.constraint_table_usage
            (constraint_catalog, constraint_name, constraint_schema, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.data_type_privileges
            (dtd_identifier, object_catalog, object_name, object_schema, object_type) as
-- missing source code
;

create or replace view information_schema.domain_constraints
            (constraint_catalog, constraint_name, constraint_schema, domain_catalog, domain_name, domain_schema,
             initially_deferred, is_deferrable)
as
-- missing source code
;

create or replace view information_schema.domain_udt_usage
            (domain_catalog, domain_name, domain_schema, udt_catalog, udt_name, udt_schema) as
-- missing source code
;

create or replace view information_schema.domains
            (character_maximum_length, character_octet_length, character_set_catalog, character_set_name,
             character_set_schema, collation_catalog, collation_name, collation_schema, data_type, datetime_precision,
             domain_catalog, domain_default, domain_name, domain_schema, dtd_identifier, interval_precision,
             interval_type, maximum_cardinality, numeric_precision, numeric_precision_radix, numeric_scale,
             scope_catalog, scope_name, scope_schema, udt_catalog, udt_name, udt_schema)
as
-- missing source code
;

create or replace view information_schema.element_types
            (character_maximum_length, character_octet_length, character_set_catalog, character_set_name,
             character_set_schema, collation_catalog, collation_name, collation_schema, collection_type_identifier,
             data_type, datetime_precision, domain_default, dtd_identifier, interval_precision, interval_type,
             maximum_cardinality, numeric_precision, numeric_precision_radix, numeric_scale, object_catalog,
             object_name, object_schema, object_type, scope_catalog, scope_name, scope_schema, udt_catalog, udt_name,
             udt_schema)
as
-- missing source code
;

create or replace view information_schema.enabled_roles(role_name) as
-- missing source code
;

create or replace view information_schema.foreign_data_wrapper_options
            (foreign_data_wrapper_catalog, foreign_data_wrapper_name, option_name, option_value) as
-- missing source code
;

create or replace view information_schema.foreign_data_wrappers
            (authorization_identifier, foreign_data_wrapper_catalog, foreign_data_wrapper_language,
             foreign_data_wrapper_name, library_name)
as
-- missing source code
;

create or replace view information_schema.foreign_server_options
            (foreign_server_catalog, foreign_server_name, option_name, option_value) as
-- missing source code
;

create or replace view information_schema.foreign_servers
            (authorization_identifier, foreign_data_wrapper_catalog, foreign_data_wrapper_name, foreign_server_catalog,
...
create or replace view information_schema.foreign_table_options
            (foreign_table_catalog, foreign_table_name, foreign_table_schema, option_name, option_value) as
-- missing source code
;

create or replace view information_schema.foreign_tables
            (foreign_server_catalog, foreign_server_name, foreign_table_catalog, foreign_table_name,
             foreign_table_schema) as
-- missing source code
;

create or replace view information_schema.information_schema_catalog_name(catalog_name) as
-- missing source code
;

create or replace view information_schema.key_column_usage
            (column_name, constraint_catalog, constraint_name, constraint_schema, ordinal_position,
             position_in_unique_constraint, table_catalog, table_name, table_schema)
as
-- missing source code
;

create or replace view information_schema.parameters
            (as_locator, character_maximum_length, character_octet_length, character_set_catalog, character_set_name,
             character_set_schema, collation_catalog, collation_name, collation_schema, data_type, datetime_precision,
             dtd_identifier, interval_precision, interval_type, is_result, maximum_cardinality, numeric_precision,
             numeric_precision_radix, numeric_scale, ordinal_position, parameter_default, parameter_mode,
             parameter_name, scope_catalog, scope_name, scope_schema, specific_catalog, specific_name, specific_schema,
             udt_catalog, udt_name, udt_schema)
as
-- missing source code
;

create or replace view pg_catalog.pg_available_extension_versions
            (comment, installed, name, relocatable, requires, schema, superuser, version) as
-- missing source code
;

create or replace view pg_catalog.pg_available_extensions(comment, default_version, installed_version, name) as
-- missing source code
;

create or replace view pg_catalog.pg_config(name, setting) as
-- missing source code
;

create or replace view pg_catalog.pg_cursors(creation_time, is_binary, is_holdable, is_scrollable, name, statement) as
-- missing source code
;

create or replace view pg_catalog.pg_file_settings(applied, error, name, seqno, setting, sourcefile, sourceline) as
-- missing source code
;

create or replace view pg_catalog.pg_group(grolist, groname, grosysid) as
-- missing source code
;

create or replace view pg_catalog.pg_hba_file_rules
            (address, auth_method, database, error, line_number, netmask, options, type, user_name) as
-- missing source code
;

create or replace view pg_catalog.pg_indexes(indexdef, indexname, schemaname, tablename, tablespace) as
-- missing source code
;

create or replace view pg_catalog.pg_locks
            (classid, database, fastpath, granted, locktype, mode, objid, objsubid, page, pid, relation, transactionid,
             tuple, virtualtransaction, virtualxid)
as
-- missing source code
;

create or replace view pg_catalog.pg_matviews
            (definition, hasindexes, ispopulated, matviewname, matviewowner, schemaname, tablespace) as
-- missing source code
;

create or replace view pg_catalog.pg_policies
            (cmd, permissive, policyname, qual, roles, schemaname, tablename, with_check) as
-- missing source code
;

create or replace view pg_catalog.pg_prepared_statements(from_sql, name, parameter_types, prepare_time, statement) as
-- missing source code
;

create or replace view pg_catalog.pg_prepared_xacts(database, gid, owner, prepared, transaction) as
-- missing source code
;

create or replace view pg_catalog.pg_publication_tables(pubname, schemaname, tablename) as
-- missing source code
;

create or replace view pg_catalog.pg_replication_origin_status(external_id, local_id, local_lsn, remote_lsn) as
-- missing source code
;

create or replace view pg_catalog.pg_replication_slots
            (active, active_pid, catalog_xmin, confirmed_flush_lsn, database, datoid, plugin, restart_lsn, slot_name,
             slot_type, temporary, xmin)
as
-- missing source code
;

create or replace view pg_catalog.pg_roles
            (oid, rolbypassrls, rolcanlogin, rolconfig, rolconnlimit, rolcreatedb, rolcreaterole, rolinherit, rolname,
             rolpassword, rolreplication, rolsuper, rolvaliduntil)
as
-- missing source code
;

create or replace view pg_catalog.pg_rules(definition, rulename, schemaname, tablename) as
-- missing source code
;

create or replace view pg_catalog.pg_seclabels
            (classoid, label, objname, objnamespace, objoid, objsubid, objtype, provider) as
-- missing source code
;

create or replace view pg_catalog.pg_sequences
            (cache_size, cycle, data_type, increment_by, last_value, max_value, min_value, schemaname, sequencename,
             sequenceowner, start_value)
as
-- missing source code
;

create or replace view pg_catalog.pg_settings
            (boot_val, category, context, enumvals, extra_desc, max_val, min_val, name, pending_restart, reset_val,
             setting, short_desc, source, sourcefile, sourceline, unit, vartype)
as
-- missing source code
;

create or replace rule pg_catalog.pg_settings_n as
    on update to pg_catalog.pg_settings
    do instead -- no commands
;

create or replace rule pg_catalog.pg_settings_u as
    on update to pg_catalog.pg_settings
    do also -- no commands
;

create or replace view pg_catalog.pg_shadow
            (passwd, usebypassrls, useconfig, usecreatedb, usename, userepl, usesuper, usesysid, valuntil) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_activity
            (application_name, backend_start, backend_type, backend_xid, backend_xmin, client_addr, client_hostname,
             client_port, datid, datname, pid, query, query_start, state, state_change, usename, usesysid, wait_event,
             wait_event_type, xact_start)
as
-- missing source code
;

create or replace view pg_catalog.pg_stat_all_indexes
            (idx_scan, idx_tup_fetch, idx_tup_read, indexrelid, indexrelname, relid, relname, schemaname) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_all_tables
            (analyze_count, autoanalyze_count, autovacuum_count, idx_scan, idx_tup_fetch, last_analyze,
             last_autoanalyze, last_autovacuum, last_vacuum, n_dead_tup, n_live_tup, n_mod_since_analyze, n_tup_del,
             n_tup_hot_upd, n_tup_ins, n_tup_upd, relid, relname, schemaname, seq_scan, seq_tup_read, vacuum_count)
as
-- missing source code
;

create or replace view pg_catalog.pg_stat_archiver
            (archived_count, failed_count, last_archived_time, last_archived_wal, last_failed_time, last_failed_wal,
             stats_reset) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_bgwriter
            (buffers_alloc, buffers_backend, buffers_backend_fsync, buffers_checkpoint, buffers_clean,
             checkpoint_sync_time, checkpoint_write_time, checkpoints_req, checkpoints_timed, maxwritten_clean,
             stats_reset)
as
-- missing source code
;

create or replace view pg_catalog.pg_stat_database
            (blk_read_time, blk_write_time, blks_hit, blks_read, conflicts, datid, datname, deadlocks, numbackends,
             stats_reset, temp_bytes, temp_files, tup_deleted, tup_fetched, tup_inserted, tup_returned, tup_updated,
             xact_commit, xact_rollback)
as
-- missing source code
;

create or replace view pg_catalog.pg_stat_database_conflicts
            (confl_bufferpin, confl_deadlock, confl_lock, confl_snapshot, confl_tablespace, datid, datname) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_progress_vacuum
            (datid, datname, heap_blks_scanned, heap_blks_total, heap_blks_vacuumed, index_vacuum_count,
             max_dead_tuples, num_dead_tuples, phase, pid, relid)
as
-- missing source code
;

create or replace view pg_catalog.pg_stat_replication
            (application_name, backend_start, backend_xmin, client_addr, client_hostname, client_port, flush_lag,
             flush_lsn, pid, replay_lag, replay_lsn, sent_lsn, state, sync_priority, sync_state, usename, usesysid,
             write_lag, write_lsn)
as
-- missing source code
;

create or replace view pg_catalog.pg_stat_ssl(bits, cipher, clientdn, compression, pid, ssl, version) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_subscription
            (last_msg_receipt_time, last_msg_send_time, latest_end_lsn, latest_end_time, pid, received_lsn, relid,
             subid, subname) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_sys_indexes
            (idx_scan, idx_tup_fetch, idx_tup_read, indexrelid, indexrelname, relid, relname, schemaname) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_sys_tables
            (analyze_count, autoanalyze_count, autovacuum_count, idx_scan, idx_tup_fetch, last_analyze,
             last_autoanalyze, last_autovacuum, last_vacuum, n_dead_tup, n_live_tup, n_mod_since_analyze, n_tup_del,
             n_tup_hot_upd, n_tup_ins, n_tup_upd, relid, relname, schemaname, seq_scan, seq_tup_read, vacuum_count)
as
...
create or replace view pg_catalog.pg_stat_user_functions(calls, funcid, funcname, schemaname, self_time, total_time) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_user_indexes
            (idx_scan, idx_tup_fetch, idx_tup_read, indexrelid, indexrelname, relid, relname, schemaname) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_user_tables
            (analyze_count, autoanalyze_count, autovacuum_count, idx_scan, idx_tup_fetch, last_analyze,
             last_autoanalyze, last_autovacuum, last_vacuum, n_dead_tup, n_live_tup, n_mod_since_analyze, n_tup_del,
             n_tup_hot_upd, n_tup_ins, n_tup_upd, relid, relname, schemaname, seq_scan, seq_tup_read, vacuum_count)
as
...
create or replace view pg_catalog.pg_stat_wal_receiver
            (conninfo, last_msg_receipt_time, last_msg_send_time, latest_end_lsn, latest_end_time, pid,
             receive_start_lsn, receive_start_tli, received_lsn, received_tli, sender_host, sender_port, slot_name,
             status)
as
-- missing source code
;

create or replace view pg_catalog.pg_stat_xact_all_tables
            (idx_scan, idx_tup_fetch, n_tup_del, n_tup_hot_upd, n_tup_ins, n_tup_upd, relid, relname, schemaname,
             seq_scan, seq_tup_read)
as
-- missing source code
;

create or replace view pg_catalog.pg_stat_xact_sys_tables
            (idx_scan, idx_tup_fetch, n_tup_del, n_tup_hot_upd, n_tup_ins, n_tup_upd, relid, relname, schemaname,
             seq_scan, seq_tup_read)
as
-- missing source code
...
create or replace view pg_catalog.pg_stat_xact_user_functions(calls, funcid, funcname, schemaname, self_time, total_time) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_xact_user_tables
            (idx_scan, idx_tup_fetch, n_tup_del, n_tup_hot_upd, n_tup_ins, n_tup_upd, relid, relname, schemaname,
             seq_scan, seq_tup_read)
as
-- missing source code
...
create or replace view pg_catalog.pg_statio_all_indexes
            (idx_blks_hit, idx_blks_read, indexrelid, indexrelname, relid, relname, schemaname) as
-- missing source code
;

create or replace view pg_catalog.pg_statio_all_sequences(blks_hit, blks_read, relid, relname, schemaname) as
-- missing source code
;

create or replace view pg_catalog.pg_statio_all_tables
            (heap_blks_hit, heap_blks_read, idx_blks_hit, idx_blks_read, relid, relname, schemaname, tidx_blks_hit,
             tidx_blks_read, toast_blks_hit, toast_blks_read)
as
-- missing source code
;

create or replace view pg_catalog.pg_statio_sys_indexes
            (idx_blks_hit, idx_blks_read, indexrelid, indexrelname, relid, relname, schemaname) as
-- missing source code
;

create or replace view pg_catalog.pg_statio_sys_sequences(blks_hit, blks_read, relid, relname, schemaname) as
-- missing source code
;

create or replace view pg_catalog.pg_statio_sys_tables
            (heap_blks_hit, heap_blks_read, idx_blks_hit, idx_blks_read, relid, relname, schemaname, tidx_blks_hit,
             tidx_blks_read, toast_blks_hit, toast_blks_read)
as
-- missing source code
...
create or replace view pg_catalog.pg_statio_user_indexes
            (idx_blks_hit, idx_blks_read, indexrelid, indexrelname, relid, relname, schemaname) as
-- missing source code
;

create or replace view pg_catalog.pg_statio_user_sequences(blks_hit, blks_read, relid, relname, schemaname) as
-- missing source code
;

create or replace view pg_catalog.pg_statio_user_tables
            (heap_blks_hit, heap_blks_read, idx_blks_hit, idx_blks_read, relid, relname, schemaname, tidx_blks_hit,
             tidx_blks_read, toast_blks_hit, toast_blks_read)
as
-- missing source code
...
create or replace view pg_catalog.pg_stats
            (attname, avg_width, correlation, elem_count_histogram, histogram_bounds, inherited, most_common_elem_freqs,
             most_common_elems, most_common_freqs, most_common_vals, n_distinct, null_frac, schemaname, tablename)
as
-- missing source code
;

create or replace view pg_catalog.pg_tables
            (hasindexes, hasrules, hastriggers, rowsecurity, schemaname, tablename, tableowner, tablespace) as
-- missing source code
;

create or replace view pg_catalog.pg_timezone_abbrevs(abbrev, is_dst, utc_offset) as
-- missing source code
;

create or replace view pg_catalog.pg_timezone_names(abbrev, is_dst, name, utc_offset) as
-- missing source code
;

create or replace view pg_catalog.pg_user
            (passwd, usebypassrls, useconfig, usecreatedb, usename, userepl, usesuper, usesysid, valuntil) as
-- missing source code
;

create or replace view pg_catalog.pg_user_mappings(srvid, srvname, umid, umoptions, umuser, usename) as
-- missing source code
;

create or replace view pg_catalog.pg_views(definition, schemaname, viewname, viewowner) as
-- missing source code
;

create or replace view information_schema.referential_constraints
            (constraint_catalog, constraint_name, constraint_schema, delete_rule, match_option,
             unique_constraint_catalog, unique_constraint_name, unique_constraint_schema, update_rule)
as
-- missing source code
;

create or replace view information_schema.role_column_grants
            (column_name, grantee, grantor, is_grantable, privilege_type, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.role_routine_grants
            (grantee, grantor, is_grantable, privilege_type, routine_catalog, routine_name, routine_schema,
             specific_catalog, specific_name, specific_schema)
as
-- missing source code
;

create or replace view information_schema.role_table_grants
            (grantee, grantor, is_grantable, privilege_type, table_catalog, table_name, table_schema, with_hierarchy) as
-- missing source code
;

create or replace view information_schema.role_udt_grants
            (grantee, grantor, is_grantable, privilege_type, udt_catalog, udt_name, udt_schema) as
-- missing source code
;

create or replace view information_schema.role_usage_grants
            (grantee, grantor, is_grantable, object_catalog, object_name, object_schema, object_type, privilege_type) as
-- missing source code
;

create or replace view information_schema.routine_privileges
            (grantee, grantor, is_grantable, privilege_type, routine_catalog, routine_name, routine_schema,
             specific_catalog, specific_name, specific_schema)
as
-- missing source code
...
create or replace view information_schema.routines
            (as_locator, character_maximum_length, character_octet_length, character_set_catalog, character_set_name,
             character_set_schema, collation_catalog, collation_name, collation_schema, created, data_type,
             datetime_precision, dtd_identifier, external_language, external_name, interval_precision, interval_type,
             is_deterministic, is_implicitly_invocable, is_null_call, is_udt_dependent, is_user_defined_cast,
             last_altered, max_dynamic_result_sets, maximum_cardinality, module_catalog, module_name, module_schema,
             new_savepoint_level, numeric_precision, numeric_precision_radix, numeric_scale, parameter_style,
             result_cast_as_locator, result_cast_char_max_length, result_cast_char_octet_length,
             result_cast_char_set_catalog, result_cast_char_set_name, result_cast_char_set_schema,
             result_cast_collation_catalog, result_cast_collation_name, result_cast_collation_schema,
             result_cast_datetime_precision, result_cast_dtd_identifier, result_cast_from_data_type,
             result_cast_interval_precision, result_cast_interval_type, result_cast_maximum_cardinality,
             result_cast_numeric_precision, result_cast_numeric_precision_radix, result_cast_numeric_scale,
             result_cast_scope_catalog, result_cast_scope_name, result_cast_scope_schema, result_cast_type_udt_catalog,
             result_cast_type_udt_name, result_cast_type_udt_schema, routine_body, routine_catalog, routine_definition,
             routine_name, routine_schema, routine_type, schema_level_routine, scope_catalog, scope_name, scope_schema,
             security_type, specific_catalog, specific_name, specific_schema, sql_data_access, sql_path,
             to_sql_specific_catalog, to_sql_specific_name, to_sql_specific_schema, type_udt_catalog, type_udt_name,
             type_udt_schema, udt_catalog, udt_name, udt_schema)
as
-- missing source code
;

create or replace view information_schema.schemata
            (catalog_name, default_character_set_catalog, default_character_set_name, default_character_set_schema,
             schema_name, schema_owner, sql_path)
as
-- missing source code
;

create or replace view information_schema.sequences
            (cycle_option, data_type, increment, maximum_value, minimum_value, numeric_precision,
             numeric_precision_radix, numeric_scale, sequence_catalog, sequence_name, sequence_schema, start_value)
as
-- missing source code
;

create or replace view information_schema.table_constraints
            (constraint_catalog, constraint_name, constraint_schema, constraint_type, enforced, initially_deferred,
             is_deferrable, table_catalog, table_name, table_schema)
as
-- missing source code
;

create or replace view information_schema.table_privileges
            (grantee, grantor, is_grantable, privilege_type, table_catalog, table_name, table_schema, with_hierarchy) as
-- missing source code
;

create or replace view information_schema.tables
            (commit_action, is_insertable_into, is_typed, reference_generation, self_referencing_column_name,
             table_catalog, table_name, table_schema, table_type, user_defined_type_catalog, user_defined_type_name,
             user_defined_type_schema)
as
-- missing source code
;

create or replace view information_schema.transforms
            (group_name, specific_catalog, specific_name, specific_schema, transform_type, udt_catalog, udt_name,
             udt_schema) as
-- missing source code
;

create or replace view information_schema.triggered_update_columns
            (event_object_catalog, event_object_column, event_object_schema, event_object_table, trigger_catalog,
             trigger_name, trigger_schema)
as
-- missing source code
;

create or replace view information_schema.triggers
            (action_condition, action_order, action_orientation, action_reference_new_row, action_reference_new_table,
             action_reference_old_row, action_reference_old_table, action_statement, action_timing, created,
             event_manipulation, event_object_catalog, event_object_schema, event_object_table, trigger_catalog,
             trigger_name, trigger_schema)
as
-- missing source code
;

create or replace view information_schema.udt_privileges
            (grantee, grantor, is_grantable, privilege_type, udt_catalog, udt_name, udt_schema) as
-- missing source code
;

create or replace view information_schema.usage_privileges
            (grantee, grantor, is_grantable, object_catalog, object_name, object_schema, object_type, privilege_type) as
-- missing source code
;

create or replace view information_schema.user_defined_types
            (character_maximum_length, character_octet_length, character_set_catalog, character_set_name,
             character_set_schema, collation_catalog, collation_name, collation_schema, data_type, datetime_precision,
             interval_precision, interval_type, is_final, is_instantiable, numeric_precision, numeric_precision_radix,
             numeric_scale, ordering_category, ordering_form, ordering_routine_catalog, ordering_routine_name,
             ordering_routine_schema, ref_dtd_identifier, reference_type, source_dtd_identifier,
             user_defined_type_catalog, user_defined_type_category, user_defined_type_name, user_defined_type_schema)
as
-- missing source code
;

create or replace view information_schema.user_mapping_options
            (authorization_identifier, foreign_server_catalog, foreign_server_name, option_name, option_value) as
-- missing source code
;

create or replace view information_schema.user_mappings(authorization_identifier, foreign_server_catalog, foreign_server_name) as
-- missing source code
;

create or replace view information_schema.view_column_usage
            (column_name, table_catalog, table_name, table_schema, view_catalog, view_name, view_schema) as
-- missing source code
;

create or replace view information_schema.view_routine_usage
            (specific_catalog, specific_name, specific_schema, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.view_table_usage
            (table_catalog, table_name, table_schema, view_catalog, view_name, view_schema) as
-- missing source code
;

create or replace view information_schema.views
            (check_option, is_insertable_into, is_trigger_deletable, is_trigger_insertable_into, is_trigger_updatable,
             is_updatable, table_catalog, table_name, table_schema, view_definition)
as
-- missing source code
;
...
create or replace function pg_catalog.aclexplode(acl aclitem[], out grantee oid, out grantor oid,
                                                 out is_grantable boolean, out privilege_type text)
    stable
    strict
    cost 1
    rows 10
...
create or replace function pg_catalog.age(timestamp with time zone) returns interval
    stable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.age(timestamp without time zone) returns interval
    stable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.anytextcat(anynonarray, text) returns text
    stable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.bit_length(bit) returns integer
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.bit_length(bytea) returns integer
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.bit_length(text) returns integer
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.bpchar(char, integer, boolean)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpchar_larger(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpchar_pattern_ge(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpchar_pattern_gt(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpchar_pattern_le(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpchar_pattern_lt(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpchar_smaller(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharcmp(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpchareq(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharge(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpchargt(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpchariclike(char, text)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharicnlike(char, text)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharicregexeq(char, text)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharicregexne(char, text)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharle(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharlike(char, text)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharlt(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharne(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharnlike(char, text)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharout(char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharregexeq(char, text)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharregexne(char, text)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.bpcharsend(char)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.btbpchar_pattern_cmp(char, char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.char_length(char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.character_length(char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.col_description(oid, integer) returns text
    stable
    strict
    language sql
as -- missing source code
...
create or replace function pg_catalog.concat("any")
    stable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.concat_ws(text, "any")
    stable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.cume_dist_final(internal, "any")
    immutable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.cursor_to_xml(count integer, cursor refcursor, nulls boolean, tableforest boolean,
                                                    targetns text)
    strict
    language internal
as -- missing source code
...
create or replace function pg_catalog.date_gt_timestamp(date, timestamp)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.date_part(text, abstime) returns double precision
    stable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.date_part(text, date) returns double precision
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.date_part(text, reltime) returns double precision
    stable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.dense_rank_final(internal, "any")
    immutable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.format(text, "any")
    stable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.generate_series(timestamp, timestamp, interval)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.gin_consistent_jsonb(internal, smallint, jsonb, integer, internal, internal,
                                                           internal, internal)
    immutable
    strict
    cost 1
...
create or replace function pg_catalog.gin_consistent_jsonb_path(internal, smallint, jsonb, integer, internal, internal,
                                                                internal, internal)
    immutable
    strict
    cost 1
...
create or replace function pg_catalog.gin_tsquery_consistent(internal, smallint, tsvector, integer, internal, internal,
                                                             internal, internal)
    immutable
    strict
    cost 1
...
create or replace function pg_catalog.ginarrayconsistent(internal, smallint, anyarray, integer, internal, internal,
                                                         internal, internal)
    immutable
    strict
    cost 1
...
create or replace function pg_catalog.hashbpchar(char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.hashbpcharextended(char, bigint)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.in_range(time, time, interval, boolean, boolean)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.in_range(timestamp with time zone, timestamp with time zone, interval, boolean,
                                               boolean)
    stable
    strict
    cost 1
...
create or replace function pg_catalog.in_range(timestamp, timestamp, interval, boolean, boolean)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.int8pl_inet(bigint, inet) returns inet
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.integer_pl_date(integer, date) returns date
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.interval_pl_date(interval, date) returns timestamp without time zone
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.interval_pl_time(interval, time without time zone) returns time without time zone
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.interval_pl_timestamp(interval, timestamp without time zone) returns timestamp without time zone
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.interval_pl_timestamptz(interval, timestamp with time zone) returns timestamp with time zone
    stable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.interval_pl_timetz(interval, time with time zone) returns time with time zone
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.json_array_element(element_index integer, from_json json)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.json_array_element_text(element_index integer, from_json json)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.json_build_array("any")
    stable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.json_build_object("any")
    stable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.json_extract_path(from_json json, path_elems text[])
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.json_extract_path_text(from_json json, path_elems text[])
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.json_object_field(field_name text, from_json json)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.json_object_field_text(field_name text, from_json json)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.json_populate_record(base anyelement, from_json json,
...
create or replace function pg_catalog.json_populate_recordset(base anyelement, from_json json,
                                                              use_json_as_text boolean default false)
    stable
    cost 1
    rows 100
...
create or replace function pg_catalog.jsonb_array_element(element_index integer, from_json jsonb)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.jsonb_array_element_text(element_index integer, from_json jsonb)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.jsonb_build_array("any")
    stable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.jsonb_build_object("any")
    stable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.jsonb_delete(from_json jsonb, path_elems text[])
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.jsonb_extract_path(from_json jsonb, path_elems text[])
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.jsonb_extract_path_text(from_json jsonb, path_elems text[])
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.jsonb_insert(insert_after boolean default false, jsonb_in jsonb, path text[],
                                                   replacement jsonb)
    immutable
    strict
    cost 1
...
create or replace function pg_catalog.jsonb_object_field(field_name text, from_json jsonb)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.jsonb_object_field_text(field_name text, from_json jsonb)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.jsonb_set(create_if_missing boolean default true, jsonb_in jsonb, path text[],
                                                replacement jsonb)
    immutable
    strict
    cost 1
...
create or replace function pg_catalog.length(char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.log(numeric) returns numeric
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.lpad(text, integer) returns text
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.make_date(day integer, month integer, year integer)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.make_interval(days integer default 0, hours integer default 0,
                                                    mins integer default 0, months integer default 0,
                                                    secs double precision default 0.0, weeks integer default 0,
...
create or replace function pg_catalog.make_timestamp(hour integer, mday integer, min integer, month integer,
...
create or replace function pg_catalog.make_timestamptz(hour integer, mday integer, min integer, month integer,
                                                       sec double precision, year integer)
    stable
    strict
    cost 1
...
create or replace function pg_catalog.name(char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.name(varchar)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.num_nonnulls("any")
    immutable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.num_nulls("any")
    immutable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.obj_description(oid) returns text
    stable
    strict
    language sql
as -- missing source code
...
create or replace function pg_catalog.obj_description(oid, name) returns text
    stable
    strict
    language sql
as -- missing source code
...
create or replace function pg_catalog.octet_length(char)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.ordered_set_transition_multi(internal, "any")
    immutable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog."overlaps"(time with time zone, time with time zone, time with time zone,
                                                 time with time zone)
    immutable
    cost 1
    language internal
...
create or replace function pg_catalog."overlaps"(time without time zone, interval, time without time zone, interval) returns boolean
    immutable
    cost 1
    language sql
as -- missing source code
...
create or replace function pg_catalog."overlaps"(time without time zone, interval, time without time zone,
...
create or replace function pg_catalog."overlaps"(time without time zone, time without time zone, time without time zone,
...
create or replace function pg_catalog."overlaps"(time, time, time, time)
    immutable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog."overlaps"(timestamp with time zone, interval, timestamp with time zone, interval) returns boolean
    stable
    cost 1
    language sql
as -- missing source code
...
create or replace function pg_catalog."overlaps"(timestamp with time zone, interval, timestamp with time zone,
...
create or replace function pg_catalog."overlaps"(timestamp with time zone, timestamp with time zone,
                                                 timestamp with time zone, interval) returns boolean
    stable
    cost 1
    language sql
as -- missing source code
...
create or replace function pg_catalog."overlaps"(timestamp without time zone, interval, timestamp without time zone,
                                                 interval) returns boolean
    immutable
    cost 1
    language sql
...
create or replace function pg_catalog."overlaps"(timestamp without time zone, timestamp without time zone,
...
create or replace function pg_catalog."overlaps"(timestamp, timestamp, timestamp, timestamp)
    immutable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.path_contain_pt(path, point) returns boolean
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.percent_rank_final(internal, "any")
    immutable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.pg_available_extension_versions(out comment text, out name name,
                                                                      out relocatable boolean, out requires name[],
                                                                      out schema name, out superuser boolean,
                                                                      out version text)
    stable
    strict
    cost 10
...
create or replace function pg_catalog.pg_available_extensions(out comment text, out default_version text, out name name)
    stable
    strict
    cost 10
    rows 100
...
create or replace function pg_catalog.pg_control_checkpoint(out checkpoint_lsn pg_lsn,
                                                            out checkpoint_time timestamp with time zone,
                                                            out full_page_writes boolean, out newest_commit_ts_xid xid,
                                                            out next_multi_offset xid, out next_multixact_id xid,
                                                            out next_oid oid, out next_xid text,
                                                            out oldest_active_xid xid, out oldest_commit_ts_xid xid,
                                                            out oldest_multi_dbid oid, out oldest_multi_xid xid,
...
create or replace function pg_catalog.pg_control_init(out blocks_per_segment integer, out bytes_per_wal_segment integer,
                                                      out data_page_checksum_version integer,
                                                      out database_block_size integer, out float4_pass_by_value boolean,
                                                      out float8_pass_by_value boolean,
                                                      out large_object_chunk_size integer,
                                                      out max_data_alignment integer, out max_identifier_length integer,
...
create or replace function pg_catalog.pg_control_recovery(out backup_end_lsn pg_lsn, out backup_start_lsn pg_lsn,
                                                          out end_of_backup_record_required boolean,
                                                          out min_recovery_end_lsn pg_lsn,
...
create or replace function pg_catalog.pg_control_system(out catalog_version_no integer,
...
create or replace function pg_catalog.pg_create_logical_replication_slot(out lsn pg_lsn, plugin name, slot_name name,
                                                                         out slot_name text,
...
create or replace function pg_catalog.pg_create_physical_replication_slot(immediately_reserve boolean default false,
                                                                          out lsn pg_lsn, slot_name name,
                                                                          out slot_name name,
                                                                          temporary boolean default false)
    strict
    cost 1
...
create or replace function pg_catalog.pg_cursor(out creation_time timestamp with time zone, out is_binary boolean,
...
create or replace function pg_catalog.pg_event_trigger_ddl_commands(out classid oid, out command pg_ddl_command,
                                                                    out command_tag text, out in_extension boolean,
                                                                    out object_identity text, out object_type text,
                                                                    out objid oid, out objsubid integer,
...
create or replace function pg_catalog.pg_event_trigger_dropped_objects(out address_args text[],
                                                                       out address_names text[], out classid oid,
                                                                       out is_temporary boolean, out normal boolean,
                                                                       out object_identity text, out object_name text,
                                                                       out object_type text, out objid oid,
...
create or replace function pg_catalog.pg_extension_update_paths(name name, out path text, out source text, out target text)
    stable
    strict
    cost 10
    rows 100
...
create or replace function pg_catalog.pg_get_keywords(out catcode "char", out catdesc text, out word text)
    stable
    strict
    cost 10
    rows 400
...
create or replace function pg_catalog.pg_get_multixact_members(out mode text, multixid xid, out xid xid)
    strict
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.pg_get_object_address(out classid oid, object_args text[], object_names text[],
...
create or replace function pg_catalog.pg_get_replication_slots(out active boolean, out active_pid integer,
                                                               out catalog_xmin xid, out confirmed_flush_lsn pg_lsn,
                                                               out datoid oid, out plugin name, out restart_lsn pg_lsn,
                                                               out slot_name name, out slot_type text,
...
create or replace function pg_catalog.pg_hba_file_rules(out address text, out auth_method text, out database text[],
...
create or replace function pg_catalog.pg_identify_object(classid oid, out identity text, out name text, objid oid,
...
create or replace function pg_catalog.pg_identify_object_as_address(classid oid, out object_args text[],
                                                                    out object_names text[], objid oid,
                                                                    objsubid integer, out type text)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.pg_last_committed_xact(out timestamp timestamp with time zone, out xid xid)
    strict
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.pg_lock_status(out classid oid, out database oid, out fastpath boolean,
                                                     out granted boolean, out locktype text, out mode text,
                                                     out objid oid, out objsubid smallint, out page integer,
                                                     out pid integer, out relation oid, out transactionid xid,
                                                     out tuple smallint, out virtualtransaction text,
                                                     out virtualxid text)
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.pg_logical_slot_get_binary_changes(out data bytea, out lsn pg_lsn,
                                                                         options text[] default '{}'::text[],
                                                                         slot_name name, upto_lsn pg_lsn,
                                                                         upto_nchanges integer, out xid xid)
    cost 1000
    language internal
as -- missing source code
;
...
create or replace function pg_catalog.pg_logical_slot_get_changes(out data text, out lsn pg_lsn,
...
create or replace function pg_catalog.pg_logical_slot_peek_binary_changes(out data bytea, out lsn pg_lsn,
                                                                          options text[] default '{}'::text[],
                                                                          slot_name name, upto_lsn pg_lsn,
                                                                          upto_nchanges integer, out xid xid)
    cost 1000
...
create or replace function pg_catalog.pg_logical_slot_peek_changes(out data text, out lsn pg_lsn,
                                                                   options text[] default '{}'::text[], slot_name name,
                                                                   upto_lsn pg_lsn, upto_nchanges integer, out xid xid)
    cost 1000
    language internal
...
create or replace function pg_catalog.pg_ls_logdir(out modification timestamp with time zone, out name text, out size bigint)
    strict
    cost 10
    rows 20
    language internal
...
create or replace function pg_catalog.pg_ls_waldir(out modification timestamp with time zone, out name text, out size bigint)
    strict
    cost 10
    rows 20
    language internal
...
create or replace function pg_catalog.pg_options_to_table(out option_name text, out option_value text, options_array text[])
    stable
    strict
    cost 1
    rows 3
...
create or replace function pg_catalog.pg_prepared_statement(out from_sql boolean, out name text,
...
create or replace function pg_catalog.pg_prepared_xact(out dbid oid, out gid text, out ownerid oid,
...
create or replace function pg_catalog.pg_relation_size(regclass) returns bigint
    strict
    cost 1
    language sql
as -- missing source code
...
create or replace function pg_catalog.pg_replication_slot_advance(out end_lsn pg_lsn, slot_name name, out slot_name name, upto_lsn pg_lsn)
    strict
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.pg_sequence_parameters(out cache_size bigint, out cycle_option boolean,
                                                             out data_type oid, out increment bigint,
                                                             out maximum_value bigint, out minimum_value bigint,
                                                             sequence_oid oid, out start_value bigint)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.pg_show_all_file_settings(out applied boolean, out error text, out name text,
                                                                out seqno integer, out setting text,
...
create or replace function pg_catalog.pg_show_all_settings(out boot_val text, out category text, out context text,
...
create or replace function pg_catalog.pg_show_replication_origin_status(out external_id text, out local_id oid,
...
create or replace function pg_catalog.pg_sleep_for(interval) returns void
    strict
    cost 1
    language sql
as -- missing source code
...
create or replace function pg_catalog.pg_sleep_until(timestamp with time zone) returns void
    strict
    cost 1
    language sql
as -- missing source code
...
create or replace function pg_catalog.pg_start_backup(exclusive boolean default true, fast boolean default false, label text)
    strict
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.pg_stat_file(out access timestamp with time zone,
                                                   out change timestamp with time zone,
                                                   out creation timestamp with time zone, filename text,
                                                   out isdir boolean, out modification timestamp with time zone,
                                                   out size bigint)
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.pg_stat_file(out access timestamp with time zone,
                                                   out change timestamp with time zone,
                                                   out creation timestamp with time zone, filename text,
                                                   out isdir boolean, missing_ok boolean,
...
create or replace function pg_catalog.pg_stat_get_activity(out application_name text,
                                                           out backend_start timestamp with time zone,
                                                           out backend_type text, out backend_xid xid,
                                                           out backend_xmin xid, out client_addr inet,
                                                           ...
                                                           out sslbits integer, out sslcipher text,
                                                           out sslclientdn text, out sslcompression boolean,
                                                           out sslversion text, out state text,
...
create or replace function pg_catalog.pg_stat_get_archiver(out archived_count bigint, out failed_count bigint,
...
create or replace function pg_catalog.pg_stat_get_progress_info(cmdtype text, out datid oid, out param1 bigint,
                                                                out param10 bigint, out param2 bigint,
                                                                out param3 bigint, out param4 bigint, out param5 bigint,
                                                                out param6 bigint, out param7 bigint, out param8 bigint,
                                                                out param9 bigint, out pid integer, out relid oid)
    stable
    strict
    cost 1
    rows 100
...
create or replace function pg_catalog.pg_stat_get_subscription(out last_msg_receipt_time timestamp with time zone,
                                                               out last_msg_send_time timestamp with time zone,
                                                               out latest_end_lsn pg_lsn,
                                                               out latest_end_time timestamp with time zone,
                                                               out pid integer, out received_lsn pg_lsn, out relid oid,
                                                               subid oid, out subid oid)
    stable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.pg_stat_get_wal_receiver(out conninfo text,
                                                               out last_msg_receipt_time timestamp with time zone,
                                                               out last_msg_send_time timestamp with time zone,
                                                               out latest_end_lsn pg_lsn,
                                                               out latest_end_time timestamp with time zone,
                                                               out pid integer, out receive_start_lsn pg_lsn,
                                                               out receive_start_tli integer, out received_lsn pg_lsn,
                                                               out received_tli integer, out sender_host text,
                                                               out sender_port integer, out slot_name text,
                                                               out status text)
    stable
    cost 1
    language internal
...
create or replace function pg_catalog.pg_stat_get_wal_senders(out flush_lag interval, out flush_lsn pg_lsn,
                                                              out pid integer, out replay_lag interval,
                                                              out replay_lsn pg_lsn, out sent_lsn pg_lsn,
                                                              out state text, out sync_priority integer,
                                                              out sync_state text, out write_lag interval,
...
create or replace function pg_catalog.pg_stop_backup(exclusive boolean, out labelfile text, out lsn pg_lsn,
                                                     out spcmapfile text, wait_for_archive boolean default true)
    strict
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.pg_timezone_abbrevs(out abbrev text, out is_dst boolean, out utc_offset interval)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.pg_timezone_names(out abbrev text, out is_dst boolean, out name text,
...
create or replace function pg_catalog.pg_walfile_name_offset(out file_name text, out file_offset integer, lsn pg_lsn)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.polygon(circle) returns polygon
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.query_to_xml(nulls boolean, query text, tableforest boolean, targetns text)
    strict
    language internal
as -- missing source code
;
...
create or replace function pg_catalog.query_to_xml_and_xmlschema(nulls boolean, query text, tableforest boolean, targetns text)
    strict
    language internal
as -- missing source code
;
...
create or replace function pg_catalog.query_to_xmlschema(nulls boolean, query text, tableforest boolean, targetns text)
    strict
    language internal
as -- missing source code
;
...
create or replace function pg_catalog.quote_literal(anyelement) returns text
    stable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.quote_nullable(anyelement) returns text
    stable
    cost 1
    language sql
as -- missing source code
...
create or replace function pg_catalog.rank_final(internal, "any")
    immutable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.round(numeric) returns numeric
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.rpad(text, integer) returns text
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.satisfies_hash_partition(oid, integer, integer, "any")
    immutable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.schema_to_xml(nulls boolean, schema name, tableforest boolean, targetns text)
    stable
    strict
    language internal
as -- missing source code
...
create or replace function pg_catalog.schema_to_xml_and_xmlschema(nulls boolean, schema name, tableforest boolean, targetns text)
    stable
    strict
    language internal
as -- missing source code
...
create or replace function pg_catalog.schema_to_xmlschema(nulls boolean, schema name, tableforest boolean, targetns text)
    stable
    strict
    language internal
as -- missing source code
...
create or replace function pg_catalog.shobj_description(oid, name) returns text
    stable
    strict
    language sql
as -- missing source code
...
create or replace function pg_catalog.substring(text, text, text) returns text
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.table_to_xml(nulls boolean, tableforest boolean, targetns text, tbl regclass)
    stable
    strict
    language internal
as -- missing source code
...
create or replace function pg_catalog.table_to_xml_and_xmlschema(nulls boolean, tableforest boolean, targetns text, tbl regclass)
    stable
    strict
    language internal
as -- missing source code
...
create or replace function pg_catalog.table_to_xmlschema(nulls boolean, tableforest boolean, targetns text, tbl regclass)
    stable
    strict
    language internal
as -- missing source code
...
create or replace function pg_catalog.textanycat(text, anynonarray) returns text
    stable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.time(abstime) returns time without time zone
    stable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.time(time, integer)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.time_hash(time)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.time_hash_extended(time, bigint)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timedate_pl(time without time zone, date) returns timestamp without time zone
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.timestamp(timestamp, integer)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamp_cmp_timestamptz(timestamp, timestamp with time zone)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamp_eq_timestamptz(timestamp, timestamp with time zone)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamp_ge_timestamptz(timestamp, timestamp with time zone)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamp_gt_timestamptz(timestamp, timestamp with time zone)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamp_hash(timestamp)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamp_hash_extended(timestamp, bigint)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamp_le_timestamptz(timestamp, timestamp with time zone)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamp_lt_timestamptz(timestamp, timestamp with time zone)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamp_ne_timestamptz(timestamp, timestamp with time zone)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamp_pl_interval(timestamp, interval)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamptz(date, time without time zone) returns timestamp with time zone
    stable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.timestamptz_cmp_timestamp(timestamp with time zone, timestamp)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamptz_eq_timestamp(timestamp with time zone, timestamp)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamptz_ge_timestamp(timestamp with time zone, timestamp)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamptz_gt_timestamp(timestamp with time zone, timestamp)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamptz_le_timestamp(timestamp with time zone, timestamp)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamptz_lt_timestamp(timestamp with time zone, timestamp)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timestamptz_ne_timestamp(timestamp with time zone, timestamp)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.timetzdate_pl(time with time zone, date) returns timestamp with time zone
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.trunc(numeric) returns numeric
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.ts_debug(config regconfig, document text, OUT alias text, OUT description text,
                                               OUT token text, OUT dictionaries regdictionary[],
                                               OUT dictionary regdictionary, OUT lexemes text[]) returns SETOF record
    stable
    strict
    language sql
as -- missing source code
...
create or replace function pg_catalog.ts_debug(document text, OUT alias text, OUT description text, OUT token text,
...
create or replace function pg_catalog.ts_parse(parser_oid oid, out token text, out tokid integer, txt text)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.ts_parse(parser_name text, out token text, out tokid integer, txt text)
    stable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.ts_stat(out ndoc integer, out nentry integer, query text, out word text)
    strict
    cost 10
    rows 10000
    language internal
...
create or replace function pg_catalog.ts_stat(out ndoc integer, out nentry integer, query text, weights text,
                                              out word text)
    strict
    cost 10
    rows 10000
...
create or replace function pg_catalog.ts_token_type(out alias text, out description text, parser_oid oid, out tokid integer)
    immutable
    strict
    cost 1
    rows 16
...
create or replace function pg_catalog.ts_token_type(out alias text, out description text, parser_name text,
                                                    out tokid integer)
    stable
    strict
    cost 1
...
create or replace function pg_catalog.tsrange(timestamp, timestamp)
    immutable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.tsrange(timestamp, timestamp, text)
    immutable
    cost 1
    language internal
as -- missing source code
...
create or replace function pg_catalog.tsrange_subdiff(timestamp, timestamp)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.unnest(out lexeme text, out positions smallint[], tsvector tsvector,
                                             out weights text[])
    immutable
    strict
    cost 1
...
create or replace function pg_catalog.varchar(varchar, integer, boolean)
    immutable
    strict
    cost 1
    language internal
...
create or replace function pg_catalog.xpath(text, xml) returns xml[]
    immutable
    strict
    cost 1
    language sql
...
create or replace function pg_catalog.xpath_exists(text, xml) returns boolean
    immutable
    strict
    cost 1
    language sql
